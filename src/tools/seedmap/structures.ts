...
export const STRUCTURES: StructureDef[] = [
  ...
  { type: 10, label: 'Pillager Outpost', icon: ICON('outpost'),        dims: [0] },
  { type: 1,  label: 'Desert Pyramid',   icon: ICON('desert_pyramid'), dims: [0] },
  { type: 2,  label: 'Jungle Temple',    icon: ICON('jungle_temple'),  dims: [0] },
  { type: 3,  label: 'Swamp Hut',        icon: ICON('swamp_hut'),      dims: [0] },
  { type: 4,  label: 'Igloo',            icon: ICON('igloo'),          dims: [0] },
  { type: 8,  label: 'Ocean Monument',   icon: ICON('monument'),       dims: [0] },
  { type: 9,  label: 'Woodland Mansion', icon: ICON('mansion'),        dims: [0] },
  { type: 7,  label: 'Shipwreck',        icon: ICON('shipwreck'),      dims: [0] },
  { type: 6,  label: 'Ocean Ruin',       icon: ICON('ocean_ruin'),     dims: [0] },
  { type: 14, label: 'Buried Treasure',  icon: ICON('treasure'),       dims: [0] },
  { type: 11, label: 'Ruined Portal',    icon: ICON('ruined_portal'),  dims: [0] },
  ...
  { type: 18, label: 'Nether Fortress',  icon: ICON('fortress'),       dims: [-1] },
  { type: 19, label: 'Bastion Remnant',  icon: ICON('bastion'),        dims: [-1] },
  { type: 12, label: 'Ruined Portal',    icon: ICON('ruined_portal'),  dims: [-1] },
  { type: 20, label: 'End City',         icon: ICON('end_city'),       dims: [1] },
