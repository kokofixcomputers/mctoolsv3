...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    desc: 'Enter any hex color and find the closest Minecraft wool or concrete block using perceptual color matching (CIE ΔE).',
    category: 'Reference',
    tags: ['color', 'wool', 'concrete', 'hex', 'match', 'picker', 'palette', 'build', 'pixel art'],
    badge: 'New',
  },
  {
    id: 'enchanting',
    ...
    desc: 'Pick an item and enchantments, get the optimal anvil combining order with exact XP costs per step.',
    category: 'Reference',
    tags: ['enchantment', 'anvil', 'xp', 'cost', 'order', 'combining', 'books', 'optimal', 'calculator'],
    badge: 'New',
  },
  {
    id: 'brewing',
    ...
    desc: 'Pick a potion and get the step-by-step brewing ingredients with real item icons — base, modifiers, and all.',
    category: 'Reference',
    tags: ['potion', 'brewing', 'reference', 'ingredients', 'nether wart', 'guide', 'alchemy'],
    badge: 'New',
  },
  {
    id: 'hardcore-reviver',
    path: '/hardcore-reviver',
    title: 'Hardcore Reviver',
    desc: 'Died in hardcore? Upload your level.dat to get back into Survival, and optionally turn hardcore off for good.',
    category: 'Files',
    tags: ['hardcore', 'revive', 'level.dat', 'nbt', 'gamemode', 'survival', 'spectator', 'world'],
    badge: 'New',
  },
  {
    id: 'armor-trim',
    path: '/armor-trim',
    title: 'Armor Trim Designer',
    desc: 'Kit out a 3D player with armor, apply trim patterns & materials per piece, and preview it in 3D. Import your own skin.',
    category: 'Visual',
    tags: ['armor', 'trim', '3d', 'designer', 'skin', 'preview', 'smithing', 'netherite', 'diamond'],
    badge: 'New',
  },
  {
    id: 'summon',
    ...
    desc: 'Build /summon commands — babies, custom names, AI/silent flags, and recursively stacked passengers. Or give a spawn egg.',
    category: 'Commands',
    tags: ['summon', 'mob', 'entity', 'passenger', 'spawn egg', 'nbt', 'command', 'baby', 'noai'],
    badge: 'New',
  },
  {
    id: 'cmd-convert',
  ...
  },
  {
    ...
    path: '/seed-finder',
    title: 'Seed Finder',
    desc: 'Brute-force seeds for a cluster of structures near spawn — e.g. two villages within 100 blocks plus a ruined portal.',
    category: 'World',
    tags: ['seed', 'finder', 'structure', 'village', 'cluster', 'search', 'cubiomes', 'brute force'],
    badge: 'New',
  },
  {
    id: 'seed-map',
